...
//handelmin price
  const handelMinPriceChange = (e:React.ChangeEvent<HTMLInputElement>) =>{
   ...
   const handelMaxPriceChnage = (e:React.ChangeEvent<HTMLInputElement>) =>{
    const value = e.target.value;
          ...
          <div>
            {keywords.map((keyword, index) => (
              <button
                ...
                className="block mb-2 px-4 py-2 w-full text-left border rounnded hover:bg-gray-200"
              >
                {keyword.toUpperCase()}
              </button>
            ))}
